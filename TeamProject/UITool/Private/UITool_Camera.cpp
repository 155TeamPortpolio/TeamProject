...
CUITool_Camera::CUITool_Camera()
{
}

CUITool_Camera::CUITool_Camera(const CUITool_Camera& rhs)
	: CGameObject(rhs)
{
}

HRESULT CUITool_Camera::Initialize_Prototype()
{
...
HRESULT CUITool_Camera::Initialize(INIT_DESC* pArg)
{
...
void CUITool_Camera::Priority_Update(_float dt)
{
...
void CUITool_Camera::Update(_float dt)
{
}

void CUITool_Camera::Late_Update(_float dt)
{
}

CGameObject* CUITool_Camera::Create()
{
	CUITool_Camera* instance = new CUITool_Camera();
	if (FAILED(instance->Initialize_Prototype()))
	{
		MSG_BOX("Object Create Failed : CUITool_Camera");
...
CGameObject* CUITool_Camera::Clone(INIT_DESC* pArg)
{
	CUITool_Camera* instance = new CUITool_Camera(*this);

	if (FAILED(instance->Initialize(pArg)))
	{
		MSG_BOX("Object Clone Failed : CUITool_Camera");
		Safe_Release(instance);
	}
