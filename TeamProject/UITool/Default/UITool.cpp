                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_UITOOL, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName   = NULL;// MAKEINTRESOURCEW(IDC_UITOOL);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    RECT rc{ 0, 0, UITool::g_iWinSizeX, UITool::g_iWinSizeY };
