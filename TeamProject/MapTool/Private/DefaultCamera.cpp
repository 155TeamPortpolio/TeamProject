...
HRESULT CDefaultCamera::Initialize(INIT_DESC* pArg)
{
...
void CDefaultCamera::Update(_float dt)
{
}

void CDefaultCamera::Late_Update(_float dt)
{
}
...
CDefaultCamera* CDefaultCamera::Create()
{
	...
	{
		MSG_BOX("Object Create Failed : CDefaultCamera");
...
CGameObject* CDefaultCamera::Clone(INIT_DESC* pArg)
{
	CDefaultCamera* instance = new CDefaultCamera(*this);

	if (FAILED(instance->Initialize(pArg)))
	{
		MSG_BOX("Object Clone Failed : CDefaultCamera");
		Safe_Release(instance);
	}
