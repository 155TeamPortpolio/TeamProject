...
{
	m_pGameInstance->Get_LevelMgr()->Register_Level("MapTool_Level", []()->CLevel* {return CMapToolLevel::Create("MapTool_Level"); });
	m_pGameInstance->Notify_LevelSet();
	m_pGameInstance->Get_LevelMgr()->Request_ChangeLevel("MapTool_Level", false); //로고 레벨로 시작!
}
