...
class ENGINE_DLL CCamPosCentripetalEvaluator final : public ICamPosEvaluator
{
private:
	CCamPosCentripetalEvaluator() {}
	virtual ~CCamPosCentripetalEvaluator() DEFAULT;
...
private:
	_vector3 GetPosExtended(int idx) const;
