...
public:
	...
	const vector<_float4x4>& Get_CombinedBoneMatrices() { return Get_BoneMatrices(); };
	const vector<_float4x4>& Get_TransformationBoneMatrices() { return m_TransfromationMatrices; };
