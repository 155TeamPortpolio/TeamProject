...
HRESULT CStaticMeshRenderer::Render_StaticMesh_LightAcc()
{
	...
	m_pPipeLine->BindSampler(m_pContext, 10);
...
HRESULT CStaticMeshRenderer::Ready_Target()
{
	...
	RenderTargetDesc Combined_StaticMeshDesc = { "Target_Combined_StaticMesh" , DXGI_FORMAT_R16G16B16A16_FLOAT , DXGI_FORMAT_D24_UNORM_S8_UINT, _float4(0.f, 0.0f, 0.0f, 0.0f) ,ViewportDesc.Width, ViewportDesc.Height };
