...
_bool CAnimator3D::isOverClipTiming(_float percent, _uint LayerIndex)
{
	...
	// ?¥Ï†Ñ ?ÑÎ†à???∏Îûô ?ÑÏπò < Í∏∞Ï? <= ?ÑÏû¨ ?∏Îûô ?ÑÏπò????true
...
void CAnimator3D::GUI_ShowLayerInfo()
{
	...
	int layerCount = m_AnimLayers.size();   // «ˆ¿Á ∑π¿ÃæÓ ºˆ
...
void CAnimator3D::GUI_SelectAnim()
{
	...
	for (int i = 0; i < m_pAnimClips.size(); i++)
	{
		...
		if (isSelected) {
			ImGui::SetItemDefaultFocus(); // ?†ÌÉù????™©???¨Ïª§??
		}
	}
...
//BUILDER?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°?°„Ö°
