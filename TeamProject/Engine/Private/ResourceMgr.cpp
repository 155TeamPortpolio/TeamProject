...
void CResourceMgr::Load_InitialResource()
{
	...
	m_Resources[0].m_Shaders.emplace("Shader_WeightOIT.hlsl", CShader::Create(m_pDevice, "../Bin/ShaderFiles/Shader_WeightOIT.hlsl", "Shader_WeightOIT.hlsl"));
	...
	m_Resources[0].m_ComputeShaders.emplace("CS_Hi_Z.hlsl", CComputeShader::Create(m_pDevice, "../Bin/ShaderFiles/CS_Hi_Z.hlsl", "CS_Hi_Z.hlsl"));
