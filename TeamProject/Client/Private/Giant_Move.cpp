...
void CGiant_Move::ChangeMovePatternFromIndex(_int iMoveIndex)
{
	...
	case Client::CGiant_Move::Walk_Back:
		...
		break;
	case Client::CGiant_Move::Walk_Left:
		m_pSubStateMachine->Change_State("Walk_Left");
		break;
	case Client::CGiant_Move::Walk_Right:
		m_pSubStateMachine->Change_State("Walk_Right");
		break;
	case Client::CGiant_Move::Walk_F_L:
		m_pSubStateMachine->Change_State("Walk_F_L");
		break;
	case Client::CGiant_Move::Walk_F_R:
		m_pSubStateMachine->Change_State("Walk_F_R");
		break;
	case Client::CGiant_Move::Walk_R_F:
...
/*============================================================================*/
void CGiant_Walk_Left::Enter(CGiant* pOwner)
{
	pOwner->Get_Component<CAnimator3D>()->Change_Animation("Monster_Claymore_Ani_Walk_L")
		.Apply();
}

void CGiant_Walk_Left::Update(CGiant* pOwner, _float dt)
{
}

void CGiant_Walk_Left::Exit(CGiant* pOwner)
{
}

/*============================================================================*/
void CGiant_Walk_Right::Enter(CGiant* pOwner)
{
	pOwner->Get_Component<CAnimator3D>()->Change_Animation("Monster_Claymore_Ani_Walk_R")
		.Apply();
}

void CGiant_Walk_Right::Update(CGiant* pOwner, _float dt)
{
}

void CGiant_Walk_Right::Exit(CGiant* pOwner)
{
}

/*============================================================================*/
void CGiant_Walk_F_L::Enter(CGiant* pOwner)
{
	pOwner->Get_Component<CAnimator3D>()->Change_Animation("Monster_Claymore_Ani_Walk_F_L")
		.Apply();
}

void CGiant_Walk_F_L::Update(CGiant* pOwner, _float dt)
{
}

void CGiant_Walk_F_L::Exit(CGiant* pOwner)
{
}

/*============================================================================*/
void CGiant_Walk_F_R::Enter(CGiant* pOwner)
{
	pOwner->Get_Component<CAnimator3D>()->Change_Animation("Monster_Claymore_Ani_Walk_F_R")
		.Apply();
}

void CGiant_Walk_F_R::Update(CGiant* pOwner, _float dt)
{
}

void CGiant_Walk_F_R::Exit(CGiant* pOwner)
{
}

/*============================================================================*/
void CGiant_Walk_R_F::Enter(CGiant* pOwner)
{
	pOwner->Get_Component<CAnimator3D>()->Change_Animation("Monster_Claymore_Ani_Walk_R_F")
		.Apply();
}

void CGiant_Walk_R_F::Update(CGiant* pOwner, _float dt)
{
}

void CGiant_Walk_R_F::Exit(CGiant* pOwner)
{
}
