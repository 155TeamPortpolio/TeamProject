...
{
	//_bool           isAttachBone = { true };                // ���� ���̴���
	//string          tagBone = "";                           // ���� ���϶�, ���� ���� �̸�
	//CAnimator3D* pOwnerAnimator3D = { nullptr };           // ���� ���϶�, Owner�� �ִϸ����� ������
...
{
	ImGui::BeginDisabled(true);
	ImGui::Checkbox(u8"Hit��", &m_isEnterAttackHit);
	ImGui::Checkbox(u8"ȸ�� �� �и� ����", &m_isEnterTriggerHit);
	ImGui::EndDisabled();
}
