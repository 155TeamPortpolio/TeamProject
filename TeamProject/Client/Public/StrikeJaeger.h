...
class CStrikeJaeger final : public CEnemyNormal
{
private:
    CStrikeJaeger();
    CStrikeJaeger(const CStrikeJaeger& rhg);
    virtual ~CStrikeJaeger() = default;
...
public:
    /* Getter */
    CStateMachine<CStrikeJaeger>*   GetStateMachine() const { return m_pStateMachine; }
...
private:
    CStateMachine<CStrikeJaeger>* m_pStateMachine = { nullptr };
