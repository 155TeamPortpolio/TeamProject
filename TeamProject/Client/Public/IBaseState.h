...
public:
	...
	void                 Set_OwnerStateMachine(CStateMachine<Type>* pOwner) { m_pOwnerStateMachine = pOwner; }
	CStateMachine<Type>* Get_OwnerStateMachine() { return m_pOwnerStateMachine; }
...
protected:
	...
	CStateMachine<Type>* m_pOwnerStateMachine = { nullptr };
	string			  m_strState = "";
