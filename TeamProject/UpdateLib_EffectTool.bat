...
xcopy /y "%BASE%Engine\Bin\PhysX_64.dll"           "%BASE%EffectTool\Bin\"
xcopy /y "%BASE%Engine\Bin\PhysXCommon_64.dll"     "%BASE%EffectTool\Bin\"
xcopy /y "%BASE%Engine\Bin\PhysXFoundation_64.dll" "%BASE%EffectTool\Bin\"
xcopy /y "%BASE%Engine\Bin\PhysXCooking_64.dll" "%BASE%EffectTool\Bin\"
