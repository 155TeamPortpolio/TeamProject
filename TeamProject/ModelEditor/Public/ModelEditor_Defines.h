...
static const Engine::TEXTURE_TYPE g_TextureTypeList[] =
{
    ...
    Engine::TEXTURE_TYPE::HEIGHT,
    Engine::TEXTURE_TYPE::NORMALS,
    Engine::TEXTURE_TYPE::SHININESS,
    Engine::TEXTURE_TYPE::OPACITY,
    Engine::TEXTURE_TYPE::DISPLACEMENT,
    Engine::TEXTURE_TYPE::LIGHTMAP,
    Engine::TEXTURE_TYPE::REFLECTION,
    Engine::TEXTURE_TYPE::BASE_COLOR,
    Engine::TEXTURE_TYPE::NORMAL_CAMERA,
    Engine::TEXTURE_TYPE::EMISSION_COLOR,
    Engine::TEXTURE_TYPE::METALNESS,
    Engine::TEXTURE_TYPE::DIFFUSE_ROUGHNESS,
    Engine::TEXTURE_TYPE::AMBIENT_OCCLUSION,
    Engine::TEXTURE_TYPE::SHEEN,
    Engine::TEXTURE_TYPE::CLEARCOAT,
    Engine::TEXTURE_TYPE::TRANSMISSION,
    Engine::TEXTURE_TYPE::MAYA_BASE,
    Engine::TEXTURE_TYPE::MAYA_SPECULAR,
    Engine::TEXTURE_TYPE::MAYA_SPECULAR_COLOR,
    Engine::TEXTURE_TYPE::MAYA_SPECULAR_ROUGHNESS,
    Engine::TEXTURE_TYPE::ANISOTROPY,
