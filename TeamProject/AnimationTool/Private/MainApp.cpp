...
{
	m_pGameInstance->Get_LevelMgr()->Register_Level("AnimationEdit_Level", []()->CLevel* {return CAnimationEditLevel::Create("AnimationEdit_Level"); });
	m_pGameInstance->Notify_LevelSet();
	m_pGameInstance->Get_LevelMgr()->Request_ChangeLevel("AnimationEdit_Level", false); //로고 레벨로 시작!
}
