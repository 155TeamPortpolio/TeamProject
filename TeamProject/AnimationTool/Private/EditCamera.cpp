...
HRESULT CEditCamera::Initialize(INIT_DESC* pArg)
{
...
void CEditCamera::Update(_float dt)
{
}

void CEditCamera::Late_Update(_float dt)
{
}
...
CEditCamera* CEditCamera::Create()
{
	...
	{
		MSG_BOX("Object Create Failed : CEditCamera");
...
CGameObject* CEditCamera::Clone(INIT_DESC* pArg)
{
	CEditCamera* instance = new CEditCamera(*this);

	if (FAILED(instance->Initialize(pArg)))
	{
		MSG_BOX("Object Clone Failed : CEditCamera");
		Safe_Release(instance);
	}
